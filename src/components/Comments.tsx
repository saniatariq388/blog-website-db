...
import { createComment, deleteComment, myFetch, updateComment } from '@/constant/create'
...
const deleteFunction = async (_id: string) => {
  ...
  return (
    <div className="w-2/3 p-6 bg-gradient-to-t from-purple-200 to-pink-200  hover:bg-gradient-to-r border border-[#D4D7E5] rounded-lg m-auto mb-8">
      {!isExpanded ? (
